...
public class FamilyDialog extends DialogFragment {
    ...
    public static final String DIALOG_TAG = "NameDialog";
    private FirstInterface callback;

    private EditText inputEditText;
    private Button cancelBtn, okBtn;

    public FamilyDialog(FirstInterface callback) {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        View view = getActivity().getLayoutInflater().inflate(R.layout.dialog_family, null);
        ...
        okBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                callback.familyName(inputEditText.getText().toString());
                dismiss();
            }
        });
